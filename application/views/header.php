    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Putri Chemical</div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item <?php if ($judul == "Dashboard") {
                                    echo "active";
                                } ?>">
            ...
            <li class="nav-item <?php if ($judul == "Tambah Produk" || $judul == "List Produk") {
                                    echo "active";
                                } ?>">
                ...
                <div id="collapseProduk" class="collapse <?php if ($judul == "Tambah Produk" || $judul == "List Produk") {
                                                                echo "show";
                                                            } ?> " aria-labelledby="headingProduk" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Kelola Produk </h6>
                        <a class="collapse-item <?php if ($judul == "Tambah Produk") {
                                                    echo "active";
                                                } ?>" href="<?= base_url('Produk/tambahProduk') ?>">Tambah Produk</a>
                        <a class="collapse-item <?php if ($judul == "List Produk") {
                                                    echo "active";
                                                } ?>" href="<?= base_url() ?>Produk/listProduk">List Produk</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Pengiriman Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePengiriman" aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-shipping-fast"></i>
                    <span>Pemngiriman</span>
                </a>
                <div id="collapsePengiriman" class="collapse" aria-labelledby="headingPengiriman" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Kelola Pengiriman</h6>
                        <a class="collapse-item" href="buttons.html">Buat Pengiriman</a>
                        <a class="collapse-item" href="cards.html">List Pengiriman</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Kelola Pesanan:</h6>
                        <a class="collapse-item" href="buttons.html">Pesanan Barus</a>
