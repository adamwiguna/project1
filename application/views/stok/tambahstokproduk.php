        ...
        <div class="col-lg-6">
            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                ...
                <div class="card-body">
                    ...
                    <?php echo form_open_multipart('stok/tambahstokproduk/' . $stokproduk['KodeProduk']); ?>
                    <input type="hidden" id="kode" name="kode" value="<?= $stokproduk['KodeProduk'] ?> "></input>
                    <div class="form-group">
                        <label for="produk" class="font-weight-bold">Pilih Produk</label>
                        <select class="form-control" id="produk" name="produk" aria-readonly="true">

                            <option value="<?= $stokproduk['KodeProduk']; ?>"><?= $stokproduk['NamaProduk'] . ' - [Stok = ' . $stokproduk['Stok'] . ']'; ?></option>
