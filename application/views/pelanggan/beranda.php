...
<ul id="demo5">
	<li>
		<img src="<?= base_url('assets/pelanggan/') ?>images/11.jpg" alt="" />
	...
	<li>
		<img src="<?= base_url('assets/pelanggan/') ?>images/22.jpg" alt="" />
		<div class="slide-desc">
	...
	<li>
		<img src="<?= base_url('assets/pelanggan/') ?>images/44.jpg" alt="" />
		<div class="slide-desc">
			<h3>Whole Spices Products Are Now On Line With Us</h3>
		</div>
	</li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			<a href="beverages.html"> <img class="first-slide" src="<?= base_url('assets/pelanggan/') ?>images/b1.jpg" alt="First slide"></a>

		</div>
		<div class="item">
			<a href="personalcare.html"> <img class="second-slide " src="<?= base_url('assets/pelanggan/') ?>images/b3.jpg" alt="Second slide"></a>

		</div>
		<div class="item">
			<a href="household.html"><img class="third-slide " src="<?= base_url('assets/pelanggan/') ?>images/b1.jpg" alt="Third slide"></a>
...
<div class="ban-bottom-w3l">
	<div class="container">
		<div class="col-md-6 ban-bottom3">
			<div class="ban-top">
				<img src="<?= base_url('assets/pelanggan/') ?>images/p2.jpg" class="img-responsive" alt="" />

			</div>
			<div class="ban-img">
				<div class=" ban-bottom1">
					<div class="ban-top">
						<img src="<?= base_url('assets/pelanggan/') ?>images/p3.jpg" class="img-responsive" alt="" />

					</div>
				</div>
				<div class="ban-bottom2">
					<div class="ban-top">
						<img src="<?= base_url('assets/pelanggan/') ?>images/p4.jpg" class="img-responsive" alt="" />
		...
		<div class="col-md-6 ban-bottom">
			<div class="ban-top">
				<img src="<?= base_url('assets/pelanggan/') ?>images/111.jpg" class="img-responsive" alt="" />
					...
					<div class="agile_top_brand_left_grid">
						...
						<div class="agile_top_brand_left_grid1">
							<figure>
								<div class="snipcart-item block">
									<div class="snipcart-thumb">
										<a href="products.html"><img title=" " alt=" " src="<?= base_url('assets/pelanggan/') ?>images/14.png"></a>
										<p>Fried-gram</p>
										<div class="stars">
											<i class="fa fa-star blue-star" aria-hidden="true"></i>
											<i class="fa fa-star blue-star" aria-hidden="true"></i>
